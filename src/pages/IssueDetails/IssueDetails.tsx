...
const IssueDetails = () => {
  ...
  const handleUpdateIssueStatus = (status: string): void => {
    console.log(status);
      ...
      <div className="flex justify-between border p-10 rounded-lg">
          ...
          <div className="h-[80vh] w-[60%]">
            ...
            <div className="py-5">
              ...
              <p className="text-gray-400 text-sm mt-3">
                ...
                Inventore accusamus vitae odio fugiat, nostrum asperiores
              </p>
            </div>
            ...
            <div className="mt-5">
              ...
              <Tabs defaultValue="comments" className="w-[400px]">
                ...
                <TabsContent value="history">
                  History all make changes to your account
                </TabsContent>
              </Tabs>
            </div>
          </div>
        ...
        <div className="w-full lg:w-[30%] space-y-2">
          ...
          <div className="border rounded-lg">
            <p className="border-b py-3 px-5"></p>
